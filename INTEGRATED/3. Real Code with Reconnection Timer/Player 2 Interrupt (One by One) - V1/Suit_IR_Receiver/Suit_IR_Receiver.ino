...
// ===               MAIN LOOP              ===
// ================================================================
#define RECONNECTION_THRESHOLD 1000
long reconnected_Time, disconnected_Time, reconnection_Duration = 0;
  ...
  if (shotCount > 0)
  {
    ...
    while (!is_ack)
    {
      ...
      else if (packetCheck(0, HELLO)) // reinitiate 3-way handshake
      {
        ...
        reconnection_Duration = reconnected_Time - disconnected_Time;
