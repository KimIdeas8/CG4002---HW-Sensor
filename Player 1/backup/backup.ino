...
void setup() {
    ...
    accelgyro.setZAccelOffset(434); // 1688 factory default for my test chip
    accelgyro.setXGyroOffset(34);
    accelgyro.setYGyroOffset(41);
    accelgyro.setZGyroOffset(-89);
    Serial.print(accelgyro.getXAccelOffset()); Serial.print("\t"); // -76
    Serial.print(accelgyro.getYAccelOffset()); Serial.print("\t"); // -2359
    Serial.print(accelgyro.getZAccelOffset()); Serial.print("\t"); // 1688
    Serial.print(accelgyro.getXGyroOffset()); Serial.print("\t"); // 0
    ...
    mpu.setZAccelOffset(434); // 1688 factory default for my test chip
